...
A Homebrew tap for [citrix-workspace-manager](https://github.com/5L-Labs/osx-citrix-manager-cli) (`cwm`) — safely park and unpark Citrix Workspace on macOS without rebooting.
